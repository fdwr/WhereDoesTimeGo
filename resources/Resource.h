...
#define IDM_CLEAR_ENTRIES		116
#define IDM_INSERT				117
#define IDM_START				118
#define IDM_LAP					119
#define IDM_STOP				120
#define IDM_START_TIME_TRACKING	IDM_START  // Alias for backward compatibility
#define IDM_ADD_LAP_ENTRY		IDM_LAP    // Alias for backward compatibility
